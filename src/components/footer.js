...
export default function Footer() {
  ...
  <div className="container px-6 pt-6">
    ...
    <div className="grid lg:grid-cols-3 md:grid-cols-2">
      ...
      <div className="mb-6">
        <h5 className="uppercase font-bold mb-2.5">Contacts</h5>

        <ul className="list-none mb-0">
          <li>
            <a href="#!" className="text-white">California, USA</a>
          </li>
          <li>
            <a href="#!" className="text-white">checkacard@infos.com</a>
          </li>
          <li>
            <a href="#!" className="text-white">+1 345 3948 849</a>
          </li>
          <li>
            <a href="#!" className="text-white">+! 345 9389 398</a>
          </li>
        </ul>
      </div>
    </div>
